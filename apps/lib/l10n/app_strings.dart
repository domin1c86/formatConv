...
class AppStrings {
  ...
  String selectedCount(int count) => isZh ? '已添加 $count 个文件' : '$count files added';
  ...
  String get historyHintBody => isZh ? '点击查看历史转换记录' : 'Click to view conversion history';
  String get emptyFormatHint => isZh ? '添加文件后选择目标格式，或将文件拖到格式上转换' : 'Add files, then choose a target format or drag a file onto one.';
  String get unsupportedFileType => isZh ? '未检测到可转换的文件类型' : 'No supported file types detected';
  ...
  String get defaultOutputDirectory => isZh ? '默认输出目录' : 'Default output directory';
  String get askBeforeConvert => isZh ? '每次转换前询问保存地址' : 'Ask before each conversion';
  ...
  String get resetWarning => isZh ? '确认重置所有设置和历史记录？' : 'Reset all settings and history?';
  ...
  String get heroTitle => isZh ? '转换视频、图片与音频。' : 'Convert video, images, and audio.';
  String get heroSubtitle => isZh
      ? '面向 Windows 的本地转换工作台。'
      : 'A native Windows conversion workspace.';
}
